import { getApiUrl } from "@/infra/config/env";
import { SESSION_COOKIE_NAME } from "@/shared/constants/app";
import { ApiConfigError, ApiError } from "@/infra/api/errors";
import type { ApiErrorBody, ApiRequestOptions } from "@/shared/types/api";
...
/**
 * Low-level HTTP primitive for Studio Patron.
 * Application routing stays in the Next.js App Router; this client only talks to the backend API.
 */
